...
// Drozdov_OOPP_L3.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CDrozdovOOPPL3App, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CDrozdovOOPPL3App::OnAppAbout)
...
// Создание CDrozdovOOPPL3App

CDrozdovOOPPL3App::CDrozdovOOPPL3App() noexcept
{
	// TODO: замените ниже строку идентификатора приложения строкой уникального идентификатора; рекомендуемый
	// формат для строки: ИмяКомпании.ИмяПродукта.СубПродукт.СведенияОВерсии
	SetAppID(_T("DrozdovOOPPL3.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CDrozdovOOPPL3App

CDrozdovOOPPL3App theApp;


// Инициализация CDrozdovOOPPL3App

BOOL CDrozdovOOPPL3App::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CDrozdovOOPPL3Doc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CDrozdovOOPPL3View));
	if (!pDocTemplate)
		return FALSE;
...
// Обработчики сообщений CDrozdovOOPPL3App
...
void CDrozdovOOPPL3App::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
